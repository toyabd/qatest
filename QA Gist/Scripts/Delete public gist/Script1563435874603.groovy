...
WebUI.click(findTestObject('Object Repository/Page_Discover gists/span_Back to GitHub_dropdown-caret'))

WebUI.click(findTestObject('Object Repository/Page_Discover gists/a_Your gists'))

WebUI.click(findTestObject('Page_toyabds gists/strong_Gist Name'))

WebUI.click(findTestObject('Object Repository/Page_Gist Desc/button_Delete'))
