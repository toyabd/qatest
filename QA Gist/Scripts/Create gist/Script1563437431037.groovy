...
WebUI.click(findTestObject('Page_toyabds gists/a_Create a gist'))

WebUI.setText(findTestObject('Object Repository/Page_Create a new Gist/input_Instantly share code notes and snippets_gistdescription'), 
    'test')

WebUI.setText(findTestObject('Object Repository/Page_Create a new Gist/input_Instantly share code notes and snippets_gistcontentsname'), 
    'test')

WebUI.click(findTestObject('Object Repository/Page_Create a new Gist/div_1'))

WebUI.setText(findTestObject('Object Repository/Page_Create a new Gist/div_1test'), '<div style="position: relative;"><div class="CodeMirror-gutter-wrapper" contenteditable="false" style="left: -53px;"><div class="CodeMirror-linenumber CodeMirror-gutter-elt" style="left: 0px; width: 21px;">1</div></div><pre class=" CodeMirror-line " role="presentation" style=""><span role="presentation" style="padding-right: 0.1px;">test</span></pre></div>')
